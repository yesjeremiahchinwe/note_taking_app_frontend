...
const FontThemeSettingsPage = () => {
  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-[#2B303B] font-normal tracking-[-0.2px] pt-2 lg:pt-0">
                  ...
                  >
                    <FormItem>
                      <FormLabel
                        ...
                        className={cn(
                          "cursor-pointer border-[1px] border-[#E0E4EA] rounded-xl px-5 py-4 flex items-center justify-between gap-4 w-full flex-1",

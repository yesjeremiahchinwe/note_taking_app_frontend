...
const FontThemeSettingsPage = () => {
  ...
  return (
    <section className={`${
        ...
        <h2 className="text-[#0E121B] pt-5 lg:pt-0 font-bold lg:font-semibold text-2xl lg:text-base  tracking-[-0.5px] lg:tracking-[-0.3px]">Font Theme</h2>
        <p className="text-sm text-[#2B303B] font-normal tracking-[-0.2px] pt-2 lg:pt-0">Choose your font theme:</p>
        ...
        <article className="flex flex-col gap-4 mt-6 lg:mt-[2rem]">
            <div className="bg-[#F3F5F8] border-[1px] border-[#E0E4EA] rounded-xl px-5 py-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h5 className="text-[#0E121B] m-0 text-sm font-medium tracking-[-0.2px]">Sans-serif</h5>
                        <small className="text-[#2B303B] text-sm tracking-[-0.2px]">Clean and modern, easy to read.</small>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-transparent border-[1px] border-[#E0E4EA] rounded-xl px-5 py-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h5 className="text-[#0E121B] m-0 text-sm font-medium tracking-[-0.2px]">Serif</h5>
                        <small className="text-[#2B303B] text-sm tracking-[-0.2px]">Classic and elegant for a timeless feel.</small>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-transparent border-[1px] border-[#E0E4EA] rounded-xl px-5 py-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h5 className="text-[#0E121B] m-0 text-sm font-medium tracking-[-0.2px]">Monospace</h5>
                        <small className="text-[#2B303B] text-sm tracking-[-0.2px]">Code-like, great for a technical vibe.</small>
                    </div>
                </div>
            </div>
        </article>

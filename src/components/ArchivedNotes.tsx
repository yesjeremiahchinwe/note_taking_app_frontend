...
const ArchivedNotes = () => {
  ...
  return (
    ...
    <div role="button" onClick={() => navigate("/new")} className="fixed bottom-[15%] rounded-full w-[60px] h-[60px] flex lg:hidden items-center justify-center right-[5%] z-10 bg-skyBlue text-white dark:text-white">
